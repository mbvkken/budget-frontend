        ...
        <form>
          <div>
            <label>
              ...
              <input
                type="text"
                value={this.state.loginStatus.epost}
          ...
          <div>
            <label>
              ...
              <input
                type="password"
                value={this.state.loginStatus.passord}
                onChange={this.handleInputChange.bind(this, "passord")}
              />
            </label>
          </div>
          <div>
            <PrimaryButton onClick={this.handleLoginClick.bind(this)}>
              Logg inn
            </PrimaryButton>
            <PrimaryButton onClick={this.handleRegistrering.bind(this)}>
              Registrer deg
            </PrimaryButton>
          </div>
          <div>
